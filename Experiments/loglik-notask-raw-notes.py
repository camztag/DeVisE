#########################################################################################
# Inputs raw notes, sums logprobs for all tokens, and calculateds average per.
# note.
        ...
        for item, output in zip(batch, outputs):
            ...
            for entry in prompt_lp:
                ...
                if isinstance(entry, list):
                    #list of logprob objs, last one is the actual token
                    lp_obj = entry[-1]
                else:
                    #a dict: token_id -> Logprob
                    #pick the logprob with rank==1, or fall back to last
                    lp_obj = next(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--start", type=int, default=0) #slice data start row
    parser.add_argument("--end", type=int, default=None) #slice data end row
